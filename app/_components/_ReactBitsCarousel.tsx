...
function CarouselItem({ item, index, itemWidth, round, trackItemOffset, x, transition }: CarouselItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        <div className="mb-1 font-black text-lg text-white select-none">{item.title}</div>
        <p className="text-sm text-white select-none">{item.description}</p>
      </div>
    </motion.div>
  );
}
